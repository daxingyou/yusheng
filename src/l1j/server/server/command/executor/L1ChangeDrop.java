	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		try {
			...
			if (arg1 != null && !arg1.equals("")) {
				...
				L1World.getInstance().broadcastServerMessage("系统公告" + ": " + "掉宝率已调整为" + "【"+ Config.RATE_DROP_ITEMS + " 】" + "倍" + "。");
				pc.sendPackets(new S_SystemMessage("掉宝率已调整为" + "【"+ Config.RATE_DROP_ITEMS + " 】" + "倍" + "。"));
			} else {
				pc.sendPackets(new S_SystemMessage("目前的掉宝率为" + "【"+ Config.RATE_DROP_ITEMS + " 】" + "倍" + "。"));
			}
		} catch (Exception e) {
			pc.sendPackets(new S_SystemMessage("请输入‘.掉宝倍率’。"));
		}
	}
}
