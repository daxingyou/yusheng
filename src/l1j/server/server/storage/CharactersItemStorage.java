...
public abstract class CharactersItemStorage {
	...
	public abstract void updateItemGamNo(L1ItemInstance item)
			throws Exception;

	public abstract void updateItemGamNpcId(L1ItemInstance item)
			throws Exception;
	
	public abstract void updateItemGamNpcName(L1ItemInstance item)
			throws Exception;
	
	public abstract void updateItemSeal(L1ItemInstance item)
			throws Exception;
	
	public abstract void updateItemOverSeal(L1ItemInstance item)
			throws Exception;
	
	public abstract void updateItemBless(L1ItemInstance item) throws Exception;
	
	public  abstract void updateItemAttrEnchantCount(L1ItemInstance item) throws Exception;
	...
	public abstract void updateItemTradable(L1ItemInstance item) throws Exception;

	public abstract void updateItemOndurability(L1ItemInstance item) throws SQLException;

	public abstract void updateItemCharTrade(L1ItemInstance tradeItem) throws Exception;
	
	// 更新PVP
	public abstract void updateItemPVP(L1ItemInstance item)
			throws Exception;
	
	// 更新PVE
	public abstract void updateItemPVE(L1ItemInstance item)
			throws Exception;
