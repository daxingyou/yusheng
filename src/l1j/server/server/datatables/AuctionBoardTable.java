...
import java.text.SimpleDateFormat;//修正盟屋拍卖时间 
...
public class AuctionBoardTable {
	...
	public void insertAuctionBoard(L1AuctionBoard board) {
		...
		try {
			...
			SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");//修正盟屋拍卖时间 
            String fm = sdf.format(board.getDeadline().getTime());//修正盟屋拍卖时间 
			pstm.setString(4, fm);
