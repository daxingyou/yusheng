...
public class TownTable {
	...
	public synchronized void addSalesMoney(int town_id, long price) {
		Connection con = null;
		PreparedStatement pstm = null;
		...
		long townTax = price / 100 * townTaxRate;
		long townFixTax = price / 100 * 2;
		...
		try {
			...
			pstm.setLong(1, price);
			pstm.setLong(2, townTax);
			pstm.setLong(3, townFixTax);
			pstm.setInt(4, town_id);
			pstm.execute();
			
			town.set_sales_money(town.get_sales_money() + price);
