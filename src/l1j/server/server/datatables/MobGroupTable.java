...
public class MobGroupTable {
	...
	private final Map<Integer, L1MobGroup> _mobGroupIndex = new HashMap<Integer, L1MobGroup>();
	...
	private void loadMobGroup() {
		...
		try {
			...
			while (rs.next()) {
				...
				List<L1NpcCount> minions = new CopyOnWriteArrayList<L1NpcCount>();
				for (int i = 1; i <= 7; i++) {
			...
			_log.info("怪物队伍 " + _mobGroupIndex.size() + "组");
		}
