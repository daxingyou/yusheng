...
public class L1Poison2 {
	...
	private static L1Poison2 _instance;

	public L1Poison2() {
	}

	public static L1Poison2 getInstance() {
		if (_instance == null) {
			_instance = new L1Poison2();
		}
		return _instance;
	}
		...
		public void run() {
			...
			if (_l1object instanceof L1PcInstance) {
				...
				if (_player.isDead() == false) {
					...
					_player.sendPackets(new S_Paralysis(5, _timesec, true));
	...
	class ParalysisTimer extends Thread {
		...
		public void run() {
			...
			if (_l1object instanceof L1PcInstance) {
				_player = (L1PcInstance) _l1object;
//				if (_player.isDead() == false) {
					_player.sendPackets(new S_Paralysis(5, 0,false));
					CurePoison(_l1object);
//				}
			}
