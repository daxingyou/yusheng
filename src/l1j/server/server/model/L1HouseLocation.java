...
public class L1HouseLocation {
	...
	private static final Point[] TELEPORT_LOC_GIRAN = {
			new Point(33419, 32810), new Point(33343, 32723), // 仓库、保管所
			new Point(33553, 32712), new Point(32702, 32842), }; // 赎罪使者、市场

	private static final Point[] TELEPORT_LOC_HEINE = {
			new Point(33604, 33236), new Point(33649, 33413), // 仓库、保管所
			new Point(33553, 32712), new Point(32702, 32842), }; // 赎罪使者、市场

	private static final Point[] TELEPORT_LOC_ADEN = { new Point(33966, 33253),
			new Point(33921, 33177), // 仓库、保管所
			new Point(33553, 32712), new Point(32702, 32842), }; // 赎罪使者、市场
	...
	public static int[] getHouseLoc(int houseId) { // houseId座标返
		int[] loc = new int[3];
		if (houseId == 262145) { // 1
			loc[0] = 33374;
			loc[1] = 32657;
	...
	public static int[] getBasementLoc(int houseId) { // houseId地下室座标返
		int[] loc = new int[3];
	...
	public static int[] getHouseTeleportLoc(int houseId, int number) { // houseId先座标返
		int[] loc = new int[3];
