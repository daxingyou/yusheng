...
import l1j.server.server.world.WorldElf;
 ...
 * 
 */
public class HprMprTimerElf extends TimerTask {

	private static final Log _log = LogFactory.getLog(HprMprTimerElf.class);
