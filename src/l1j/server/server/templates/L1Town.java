...
public class L1Town {
	...
	private long _sales_money;

	public long get_sales_money() {
		return _sales_money;
	}

	public void set_sales_money(long l) {
		_sales_money = l;
	}
	...
	private long _town_tax;

	public long get_town_tax() {
		return _town_tax;
	}

	public void set_town_tax(long l) {
		_town_tax = l;
	}

	private long _town_fix_tax;

	public long get_town_fix_tax() {
		return _town_fix_tax;
	}

	public void set_town_fix_tax(long l) {
		_town_fix_tax = l;
	}
}
